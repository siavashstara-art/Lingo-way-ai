...
export const DISTRICTS: DistrictInfo[] = [
  ...
  {
    id: 'carpet_trade',
    name: 'آکادمی و مترجم تخصصی تجارت فرش ایران (Carpet Bazaar Academy)',
    subtitle: 'به یاد شادروان حاج حسین علی‌میری • مکمل برنامه «فرش بازار»',
    tagline: 'مترجم صوتی حضوری فرش‌فروشان + اصطلاحات قالی، قالیچه، گلیم، کهنه ذاتی، ذرع و نیم و دو ذرع',
    icon: '🧶',
    color: 'text-rose-700',
    accentBg: 'bg-rose-700/10 hover:bg-rose-700/20',
    borderColor: 'border-rose-700/30',
    description: 'مترجم صوتی دوطرفه حضوری ویژه فرش‌فروشان و آموزش ۱۰۰٪ آفلاین واژگان تخصصی و مکالمات حجره با خریداران انگلیسی و عرب‌زبان؛ در بزرگداشت تاجر بنام فرش ایران و جهان مرحوم حاج حسین علی‌میری و معرفی برنامه «فرش بازار».',
    landmarks: ['مترجم صوتی حضوری حجره فرش', 'واژه‌نامه کهنه ذاتی و رج‌شمار', 'جدول تبدیل ذرع به فوت و متر']
  },
  {
