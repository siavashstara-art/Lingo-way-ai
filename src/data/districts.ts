...
export const DISTRICTS: DistrictInfo[] = [
  {
    ...
    subtitle: 'اولویت نخست: آموزش فارسی به انگلیسی‌زبانان',
    tagline: 'رمزگشایی تعارف، شعر، خرید در بازار سنتی و تلفظ فینگیلیش',
    icon: '🌹',
    color: 'text-emerald-600',
    accentBg: 'bg-emerald-600/10 hover:bg-emerald-600/20',
    borderColor: 'border-emerald-600/30',
    description: 'آموزش عمیق و اصیل زبان فارسی به همراه تلفظ‌های استاندارد، حکمت‌های کلامی تعارف، نحوه سفارش در چایخانه سنتی و اصطلاحات روزمره برای انگلیسی‌زبانان سراسر جهان.',
